...
{
	public static class Reader implements
			FieldReader<DoubleIndexedField>
	{
		private static final FieldReader<Double> reader = new DoubleSerializationProvider().getFieldReader();

		@Override
		public DoubleIndexedField readField(
				byte[] fieldData ) {
	...
	public static class Writer implements
			FieldWriter<FourDimensionalData, DoubleIndexedField>
	{
		private static final FieldWriter<Object, Double> writer = new DoubleSerializationProvider().getFieldWriter();

		@Override
		public byte[] getVisibility(
				FourDimensionalData rowValue,
				ByteArrayId fieldId,
				DoubleIndexedField fieldValue ) {
